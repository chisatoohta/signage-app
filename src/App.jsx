...
function PlayerPage({ ads = [], stores = [], storeCode }) {
  ...
  return (
    <div style={{ background: "black", width: "100vw", height: "100vh", overflow: "hidden", display: "flex", flexDirection: "column" }}>
      <div style={{ flex: 1, minHeight: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
        {renderMedia(currentAd)}
      </div>

      <div style={{ height: "22vh", display: "grid", gridTemplateColumns: "1fr 1fr", borderTop: "2px solid #111" }}>
        <div style={{ borderRight: "2px solid #111", display: "flex", alignItems: "center", justifyContent: "center" }}>
